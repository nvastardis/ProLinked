...
public class Advertisement : Entity<Guid>
{
    ...
    internal Advertisement UpdateAdvertisement(
        string? title,
        string? description,
        string? company,
        string? location,
    ...
    internal Advertisement AddApplication(Application newApplication)
    {
        Applications.Add(newApplication);
        return this;
    }

    internal Advertisement SetStatus(AdvertisementStatus status)
    {
        Status = status;
        return this;
    }
