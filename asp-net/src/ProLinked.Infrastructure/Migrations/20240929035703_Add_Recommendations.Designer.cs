...
namespace ProLinked.Infrastructure.Migrations
{
    ...
    [Migration("20240929035703_Add_Recommendations")]
    partial class Add_Recommendations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProLinked.Domain.Entities.Recommendations.JobRecommendation", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AspNetJobRecommendations", (string)null);
                });

            modelBuilder.Entity("ProLinked.Domain.Entities.Recommendations.PostRecommendation", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AspNetPostRecommendations", (string)null);
                });
            ...
            modelBuilder.Entity("ProLinked.Domain.Entities.Recommendations.JobRecommendation", b =>
                {
                    b.HasOne("ProLinked.Domain.Entities.Jobs.Advertisement", "Advertisement")
                        .WithMany()
                        .HasForeignKey("AdvertisementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProLinked.Domain.Entities.Recommendations.PostRecommendation", b =>
                {
                    b.HasOne("ProLinked.Domain.Entities.Posts.Post", "Post")
                        .WithMany()
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
